#!/usr/bin/env python3
"""
OBS Studio Platform Tests
Comprehensive testing for OBS Studio integration
"""
...
class TestOBSStudioIntegration(unittest.TestCase):
    """OBS Studio specific integration tests"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.base_dir = Path(__file__).parent.parent.parent.parent
        self.platform_dir = self.base_dir / 'platforms' / 'obs-studio'
    ...
    def test_obs_studio_assets_exist(self):
        """Test that OBS Studio specific assets exist"""
        required_assets = [
            'alert.html',
            'demo.html',
            'satox-logo.png',
        ...
        for asset in required_assets:
            ...
            self.assertTrue(asset_path.exists(), f"OBS Studio asset {asset} not found")
    
    def test_obs_studio_html_compatibility(self):
        """Test that HTML files are compatible with OBS Studio"""
        ...
        for html_file in html_files:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                # OBS Studio specific requirements
    ...
    def test_obs_studio_web_server(self):
        """Test that web server works for OBS Studio browser source"""
        try:
            ...
            self.fail(f"OBS Studio web server test failed: {e}")
        except Exception as e:
            self.fail(f"OBS Studio server startup failed: {e}")
    
    def test_obs_studio_browser_source_urls(self):
    ...
    def test_obs_studio_css_customization(self):
        """Test that CSS variables work for OBS Studio customization"""
        ...
        with open(alert_file, 'r', encoding='utf-8') as f:
            ...
            for var in css_vars:
                self.assertIn(var, content, f"CSS variable {var} not found in OBS Studio alert.html")
    
    def test_obs_studio_javascript_functionality(self):
        """Test that JavaScript functions work in OBS Studio"""
        ...
        with open(demo_file, 'r', encoding='utf-8') as f:
            ...
            for func in js_functions:
                self.assertIn(func, content, f"JavaScript function {func} not found in OBS Studio demo.html")
    
    def test_obs_studio_file_permissions(self):
        """Test that files have correct permissions for OBS Studio"""
        required_files = [
            'alert.html',
            'demo.html',
            'satox-logo.png',
    ...
    def test_obs_studio_directory_structure(self):
        """Test that OBS Studio directory structure is correct"""
    ...
    def test_obs_studio_script_files(self):
        """Test that OBS Studio script files exist and are valid"""
        scripts_dir = self.platform_dir / 'scripts'
...
class TestOBSStudioPerformance(unittest.TestCase):
    """OBS Studio performance tests"""
...
def run_obs_studio_tests():
    """Run all OBS Studio tests"""
    print("🎬 Running OBS Studio Platform Tests...")
    print("=" * 50)
    ...
    # Add test cases
    suite.addTests(loader.loadTestsFromTestCase(TestOBSStudioIntegration))
    suite.addTests(loader.loadTestsFromTestCase(TestOBSStudioPerformance))
    ...
    if not result.failures and not result.errors:
        print("\n✅ All OBS Studio tests passed!")
    
    return result.wasSuccessful()

if __name__ == '__main__':
    success = run_obs_studio_tests()
