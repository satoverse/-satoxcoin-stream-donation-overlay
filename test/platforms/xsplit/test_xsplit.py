#!/usr/bin/env python3
"""
XSplit Platform Tests
Comprehensive testing for XSplit integration
"""
...
class TestXSplitIntegration(unittest.TestCase):
    """XSplit specific integration tests"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.base_dir = Path(__file__).parent.parent.parent.parent
        self.platform_dir = self.base_dir / 'platforms' / 'xsplit'
    ...
    def test_xsplit_assets_exist(self):
        """Test that XSplit specific assets exist"""
        required_assets = [
            'alert.html',
            'demo.html',
            'satox-logo.png',
        ...
        for asset in required_assets:
            ...
            self.assertTrue(asset_path.exists(), f"XSplit asset {asset} not found")
    
    def test_xsplit_html_compatibility(self):
        """Test that HTML files are compatible with XSplit"""
    ...
    def test_xsplit_web_server(self):
        """Test that XSplit web server functionality works"""
    ...
    def test_xsplit_browser_source_urls(self):
    ...
    def test_xsplit_css_customization(self):
        """Test that CSS variables work for XSplit customization"""
        ...
        with open(alert_file, 'r', encoding='utf-8') as f:
            ...
            for var in css_vars:
                self.assertIn(var, content, f"CSS variable {var} not found in XSplit alert.html")
    
    def test_xsplit_javascript_functionality(self):
        """Test that JavaScript functions work in XSplit"""
        ...
        with open(demo_file, 'r', encoding='utf-8') as f:
            ...
            for func in js_functions:
                self.assertIn(func, content, f"JavaScript function {func} not found in XSplit demo.html")
    
    def test_xsplit_file_permissions(self):
        """Test that files have correct permissions for XSplit"""
        required_files = [
            'alert.html',
            'demo.html',
            'satox-logo.png',
    ...
    def test_xsplit_directory_structure(self):
        """Test that XSplit directory structure is correct"""
    ...
    def test_xsplit_script_files(self):
        """Test that XSplit script files exist and are valid"""
        scripts_dir = self.platform_dir / 'scripts'
...
class TestXSplitPerformance(unittest.TestCase):
    """XSplit performance tests"""
...
def run_xsplit_tests():
    """Run all XSplit tests"""
    print("🎬 Running XSplit Platform Tests...")
    print("=" * 50)
    ...
    # Add test cases
    suite.addTests(loader.loadTestsFromTestCase(TestXSplitIntegration))
    suite.addTests(loader.loadTestsFromTestCase(TestXSplitPerformance))
    ...
    if not result.failures and not result.errors:
        print("\n✅ All XSplit tests passed!")
    
    return result.wasSuccessful()

if __name__ == '__main__':
    success = run_xsplit_tests()
