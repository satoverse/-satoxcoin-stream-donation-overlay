...
RPC_PORT = int(os.getenv("SATOX_RPC_PORT", "7777"))  # Satoxcoin RPC port
...
def main():
    ...
    # Check configuration
    if RPC_USER == "your_rpc_username" or RPC_PASSWORD == "your_rpc_password":
        print("❌ ERROR: Please configure RPC_USER and RPC_PASSWORD in the script")
